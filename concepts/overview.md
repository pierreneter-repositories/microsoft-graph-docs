...
- Check out some [Featured scenarios](https://developer.microsoft.com/en-us/graph/docs/concepts/featured_scenarios.md).
...
- Find out how to [get an auth token](https://developer.microsoft.com/en-us/graph/docs/concepts/auth_overview.md) in your app.
- Start [using the API](https://developer.microsoft.com/en-us/graph/docs/concepts/use_the_api.md).
